                ...
                <div className='basis-5/6 relative'>
                    ...
                    <div className='flex absolute bottom-0 left-0 right-0 items-end justify-between'>
                        <div className='text-stone-500'>
                            <p className='font-bold text-sm md:text-lg line-through'>29.990.000 VNĐ</p>
                            <p className='font-bold text-base md:text-xl text-blue-500'>20.990.000 VNĐ</p>
                        </div>
                        <div className='text-stone-600 flex flex-col items-end'>
                            <div className='flex items-center text-xl'>
                                <Button className='rounded-none px-2 md:px-3'>
                                    <i className="fa-solid fa-minus"></i>
                                </Button>
                                <input htmltype='text' className='bg-stone-100 w-8 md:w-14 text-center h-8 border-solid' disabled value={1} />
                                <Button className='rounded-none px-2 md:px-3'>
                                    <i className="fa-solid fa-plus"></i>
                                </Button>
                            </div>
                            <div className='total-price mt-2'>
                                <span className='font-semibold text-sm md:text-lg'>Thành tiền: </span>
                                <span className='text-red-500 text-base md:text-xl font-semibold'>20.990.000 đ</span>
                            </div>
                        </div>
                    </div>
                </div>
