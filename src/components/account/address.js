      ...
      <div className="container pt-3 bg-slate-50">
          ...
          <div className='mx-32 my-5 grid grid-flow-row grid-cols-12 gap-9'>
            ...
            <div className='col-span-9 p-6 bg-white rounded-2xl shadow-xl'>
                <h2 className='text-xl font-bold pb-3 border-solid border-b-2 border-blue-200'>Thêm địa chỉ giao hàng</h2>
                <Form {...layout} labelAlign='left' className='my-5'>
                    <Form.Item className='font-bold text-3xl' name="city" label="Tỉnh/Tp">
                        <Input className='font-normal py-2 text-base' placeholder='Nhập tỉnh bạn ở hiện tại'/>
                    </Form.Item>
                    <Form.Item className='font-bold text-3xl' name="district" label="Huyện/Quận">
                        <Input className='font-normal py-2 text-base' placeholder='Nhập huyện/quận bạn ở hiện tại'/>
                    </Form.Item>
                    ...
                    <Form.Item labelCol={4} wrapperCol={{span: 8, offset: 4}} className='text-transparent'>
                        <Button className='bg-red-500 button text-white font-bold p-5' type='default' htmlType='submit'>Thêm địa chỉ</Button>
                    </Form.Item>
                </Form>

                <h2 className='text-xl font-bold pb-3 border-solid border-b-2 border-blue-200'>Xóa địa chỉ giao hàng</h2>
                <Form {...layout} labelAlign='left' className='my-5'>
                    <Form.Item className='font-bold text-3xl' name="city" label="Chọn địa chỉ">
                        <Select className='font-normal text-base' placeholder='Chọn địa chỉ cần xóa'>
                            <Select.Option value="1">Number 12 Nguyen Van Bao, Ward 4, Go Vap District, Ho Chi Minh City.</Select.Option>
                        </Select>
                    </Form.Item>
                    <Form.Item labelCol={4} wrapperCol={{span: 8, offset: 4}} className='text-transparent'>
                        <Button className='bg-yellow-500 button text-white font-bold p-5' type='default' htmlType='submit'>Xóa địa chỉ</Button>
                    </Form.Item>
                </Form>
            </div>
