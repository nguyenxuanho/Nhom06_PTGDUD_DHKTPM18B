  ...
  return (
    <>
      <div className="md:pt-3 pt-52 bg-slate-50">
          ...
          <h1 className='font-bold text-3xl uppercase mx-5 xl:mx-32 my-5 text-center'>Thành viên nhóm</h1>
          <div className='my-5 mx-5 xl:mx-32 grid grid-flow-row grid-cols-2 gap-5'>
            <div className='col-span-2 lg:col-span-1 rounded-xl shadow-xl max-h-max p-2 border-2 border-solid border-blue-200 flex'>
                ...
                <div className='w-2/3 px-5'>
                    <h2 className='text-center font-semibold text-2xl lg:text-3xl text-blue-600'>Nguyễn Xuân Hồ</h2>
            ...
            <div className='col-span-2 lg:col-span-1 rounded-xl shadow-xl max-h-max p-2 border-2 border-solid border-blue-200 flex'>
                ...
                <div className='w-2/3 px-5'>
                    <h2 className='text-center font-semibold text-2xl lg:text-3xl text-blue-600'>Nguyễn Thị Mỹ Hoa</h2>
                    <div className='flex my-3 font-medium text-lg items-center'>
                        <p className='w-5/12'>Lớp:</p>
                        <p>DHKTPM18B</p>
                    </div>
            ...
            <div className='col-span-2 lg:col-span-1 rounded-xl shadow-xl max-h-max p-2 border-2 border-solid border-blue-200 flex'>
                ...
                <div className='w-2/3 px-5'>
                    <h2 className='text-center font-semibold text-2xl lg:text-3xl text-blue-600'>Huỳnh Lệ Hoan</h2>
                    <div className='flex my-3 font-medium text-lg items-center'>
                        <p className='w-5/12'>Lớp:</p>
                        <p>DHKTPM18A</p>
                    </div>
            ...
            <div className='col-span-2 lg:col-span-1 rounded-xl shadow-xl max-h-max p-2 border-2 border-solid border-blue-200 flex'>
                ...
                <div className='w-2/3 px-5'>
                    <h2 className='text-center font-semibold text-2xl lg:text-3xl text-blue-600'>Phạm Minh Hiếu</h2>
                    <div className='flex my-3 font-medium text-lg items-center'>
                        <p className='w-5/12'>Lớp:</p>
                        <p>DHKTPM18B</p>
                    </div>
            ...
            <div className='col-span-2 lg:col-span-1 rounded-xl shadow-xl max-h-max p-2 border-2 border-solid border-blue-200 flex'>
                ...
                <div className='w-2/3 px-5'>
                    <h2 className='text-center font-semibold text-2xl lg:text-3xl text-blue-600'>Trần Đình Hoan</h2>
                    <div className='flex my-3 font-medium text-lg items-center'>
                        <p className='w-5/12'>Lớp:</p>
                        <p>DHKTPM18B</p>
                    </div>
