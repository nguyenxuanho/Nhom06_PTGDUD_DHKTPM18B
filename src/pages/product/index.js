        ...
        <>
            {product._id &&
                <div className="md:pt-3 pt-52 bg-slate-50 dark:bg-gray-900 dark:text-white">
                            ...
                            <div className='col-span-12 lg:col-span-9 xl:col-span-8'>
                                ...
                                <div className='px-3 my-4 py-2 border-dotted border-2 border-red-300 rounded-xl'>
                                    <div className='md:flex items-end'>
                                        <p className='text-blue-500 dark:text-red-400  inline-block md:block font-bold text-xl md:text-2xl xl:text-4xl'>{(product?.price * (1 - product?.discount)).toLocaleString()} đ</p>
                    ...
                    <div className='rounded-lg mx-5 xl:mx-32 content-body py-5 p-4 bg-white dark:bg-gray-800 shadow-lg'>
