    ...
    <>
      <div className="md:pt-3 pt-52 bg-slate-900">
          ...
          <div className='mx-5 xl:mx-32 content-header flex items-center flex-wrap'>
              ...
              <h3 className="font-medium text-white  mr-3">Liên hệ</h3>
          </div>
          
          <h3 className='text-center mx-5 xl:mx-32 uppercase py-4 my-5 font-bold text-white md:text-3xl'>Liên hệ</h3>
          <div className='mx-5 xl:mx-32 my-10 gap-5 grid grid-flow-row grid-cols-12'>
             <div className='col-span-12 lg:col-span-4 bg-white rounded-lg shadow-xl p-5'>
