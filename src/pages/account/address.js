                ...
                <div className='mx-5 xl:mx-32 my-5 grid grid-flow-row grid-cols-12 gap-0 lg:gap-9'>
                    ...
                    <div className='col-span-12 lg:col-span-9 p-6 bg-white rounded-2xl shadow-xl'>
                        ...
                        <Form {...layout} onFinish={addAddress} labelAlign='left' className='my-5'>
                            ...
                            <Form.Item className='font-bold text-3xl' name="number_home" label="Số nhà">
                        ...
                        {inforUser._id &&
                            <Form {...layout} onFinish={handleDeleteAddress} labelAlign='left' className='my-5'>
                                <Form.Item className='font-bold text-3xl' name="city" label="Chọn địa chỉ">
                                    <Select className='font-normal text-base' placeholder='Chọn địa chỉ cần xóa' defaultValue={"default"}>
